...
def increment_path(path, exist_ok=False, sep='', mkdir=False):
    """
    Increments a file or directory path, i.e. runs/hyper_hazydet_200张_100epoch --> runs/hyper_hazydet_200张_100epoch{sep}2, runs/hyper_hazydet_200张_100epoch{sep}3, ... etc.
