...
def feature_visualization(x, module_type, stage, n=32, save_dir=Path('runs/detect/hyper_hazydet_200张_100epoch')):
    """
    ...
    Args:
        ...
        save_dir (Path, optional): Directory to save results. Defaults to Path('runs/detect/hyper_hazydet_200张_100epoch').
    """
